    ...
    for pulse in spec["pulses"]:
        ...
        for target in targets:
            ...
            for radar in sorted(data.radar.unique()):
                ...
                model = xgb.XGBRegressor(n_estimators=500, max_depth=5, learning_rate=.035, subsample=.8, colsample_bytree=.9, objective="reg:squarederror", n_jobs=4)
            ...
            final = xgb.XGBRegressor(n_estimators=500, max_depth=5, learning_rate=.035, subsample=.8, colsample_bytree=.9, objective="reg:squarederror", n_jobs=4)
