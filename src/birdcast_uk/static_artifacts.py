    ...
    *,
    ...
    write_json(
        web_dir / "config.json",
        {
            ...
            "coastal_manifest_url": f"{public_base_url.rstrip('/')}/birdcast-coastal/latest/relative-flow.json",
            "coastal_page_url": "/coastal-bird-flow/",
            "generated_at_utc": generated_at,
    ...
    *,
    ...
    write_json(
        site_root / "config.json",
        {
            ...
            "europe_page_url": "/europe-bird-maps/",
            "coastal_manifest_url": "/coastal-bird-flow/data/latest/relative-flow.json",
            "coastal_page_url": "/coastal-bird-flow/",
            "generated_at_utc": generated_at,
            "object_prefix": object_prefix,
            "vpts_catalog_url": UKMO_VPTS_CATALOG_URL,
