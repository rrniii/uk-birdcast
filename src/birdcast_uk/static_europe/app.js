...
function unavailable(){document.querySelector("#statusBadge").textContent="Data unavailable";document.querySelector("#subtitle").textContent="No published European reanalysis manifest";document.querySelectorAll("input,select,button").forEach(e=>e.disabled=true)}
