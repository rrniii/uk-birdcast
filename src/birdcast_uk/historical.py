    ...
    try:
        ...
        manifest = {
            ...
            "source": {
                ...
                "complete_local_date_through": analysis.get("complete_local_date_through"),
                "input_snapshot_sha256": analysis.get("input_snapshot_sha256"),
                "catch_up_missing_source_days": analysis.get("catch_up_missing_source_days", []),
            },
            "radars": radars,
