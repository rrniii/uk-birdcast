...
EUROPE_OBJECT_PREFIX = "birdcast-euro"
EUROPE_PROCESSING_VERSION = "birdcast-euro-gamm-0.1.0"
EUROPE_PRIMARY_ALOFT_SOURCE = "baltrad"
EUROPE_UK_PULSE = "sp"
EUROPE_MIN_TRAINING_DAYS = 365
EUROPE_MIN_TRANSFER_DAYS = 90
EUROPE_REFERENCE_SOURCE = "aloft-baltrad"
EUROPE_DERIVED_PREFIX = f"{EUROPE_OBJECT_PREFIX}/derived/hourly"
EUROPE_ERA5_PREFIX = f"{EUROPE_OBJECT_PREFIX}/era5"
EUROPE_MODEL_PREFIX = f"{EUROPE_OBJECT_PREFIX}/models"
EUROPE_REANALYSIS_PREFIX = f"{EUROPE_OBJECT_PREFIX}/archive/reanalysis"
EUROPE_VALIDATION_PREFIX = f"{EUROPE_OBJECT_PREFIX}/validation"
EUROPE_GRID_CRS = "EPSG:3035"
EUROPE_ERA5_AREA = {
    "north": 72.0,
    "west": -25.0,
    "south": 33.0,
...
EUROPE_INTERPOLATION_DISTANCE_KM = 150.0
EUROPE_MAX_SUPPORT_DISTANCE_KM = 250.0
