...
def test_era5_site_merge_requires_complete_days(tmp_path: Path) -> None:
    ...
    single = {"radar": "bejab", "time_utc": "2025-07-14T00:00:00Z", "sp": 100000, "msl": 101000, "tcc": .5, "blh": 600, "tp": .001}
    pressure = {"radar": "bejab", "time_utc": "2025-07-14T00:00:00Z", "t_pressure_level_850.0": 280, "r_pressure_level_850.0": 70, "u_pressure_level_850.0": 2, "v_pressure_level_850.0": 3, "u_pressure_level_925.0": 1, "v_pressure_level_925.0": 2, "u_pressure_level_700.0": 4, "v_pressure_level_700.0": 5}
    ...
    table = __import__("pyarrow.parquet", fromlist=["read_table"]).read_table(tmp_path / "site.parquet")
